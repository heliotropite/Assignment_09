...
# AdamH, 2020-3-22, Completed classes and methods
#------------------------------------------#
...
class Track():
    ...
    def position(self, pos):
        if type(pos) == int:
            if pos < 1:
                raise Exception('Position can\'t be lower than 1.')
            self.__position = pos
        else:
            raise Exception('Position needs to be an int.')
